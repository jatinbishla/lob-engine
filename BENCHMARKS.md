...
Regenerated by the Benchmark workflow (`.github/workflows/benchmark.yml`, manual dispatch)
from a single Linux x86 runner — object pool vs system allocator, same hardware. Do not
edit by hand; anything between the markers is overwritten. The historical narrative below
(*Baseline* / *After Opt 1*) is kept as the optimization story.

<!-- BENCH:START -->
**Resting insert** — allocation-bound; the object pool's path
...
| p95 | 40 ns | 50 ns |
| p99 | 1392 ns | 1412 ns |
| p99.9 | 1833 ns | 3786 ns |

**Crossing / matching** — aggressive orders fill against resting liquidity
...
| Metric | Object pool | System allocator |
|:--|--:|--:|
| insert · BM_SubmitLimit | 73.9 ns | 93.7 ns |
| cancel · BM_Cancel | 42.5 ns | 45.3 ns |

_Runner: **AMD EPYC 9V74 80-Core Processor** · core clock pool 2596.136000 MHz / no-pool 2596.136000 MHz · TSC 2.59621 GHz · rdtsc overhead 10.0146 ns · load 1.67, 1.09, 0.45 · 2026-07-28 15:46 UTC · 1,000,000 events/workload, core-pinned._

> **Frequency-scaling caveat.** The two variants ran at different core clocks (pool 2596.136000 MHz vs no-pool 2596.136000 MHz on this shared runner), so the **p50/p95 comparison across allocators is confounded by clock, not just allocator**. The **p99.9 comparison is the robust one**: tail behaviour is allocator-dominated (malloc / arena grow), not clock-dominated.
<!-- BENCH:END -->
